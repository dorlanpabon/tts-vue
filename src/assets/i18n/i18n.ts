...
const messages = {
  en: {
    ...
    guide: {
      title: 'Quick Guide',
      intro: 'Convert text to speech in 4 steps. No account needed for the basics.',
      s1t: '1. Pick language and voice',
      s1d: 'Defaults are already Spanish (Colombia) with the Salome voice.',
      s2t: '2. Type or paste your text',
      s2d: 'Use the Text tab, or load .txt files in Batch mode.',
      s3t: '3. Press Start Conversion',
      s3d: 'Listen in the player below or download the MP3.',
      s4t: '4. For unlimited use, add your Azure key',
      s4d: 'Settings → SpeechKey + ServiceRegion, Interface → Azure Speech API.',
      faqTitle: 'Common issues',
      faq429: 'free quota exhausted, resets in ~24h. The app will offer the Azure guide.',
      faq403: 'free endpoint refusing connections. Same solution: your own Azure key.',
      faqF9: 'brings the window to the front from anywhere.',
    },
    version: {
    ...
    configPage: {
      ...
      yes: 'Yes',
      no: 'No',
      serviceRegionPlaceHolder: "Fill in the service region, such as: eastus",
      confirm: 'OK',
      voice: 'Voice',
      style: 'Style',
      role: 'Role',
      ...
      aiCustom: 'Custom',
      darkMode: 'Dark Mode',
      aiKeyHint: 'Get a free key at openrouter.ai/keys (free models) or use your OpenAI key.',
    ...
    donate: {
      ...
      viewFork: 'View fork on GitHub',
      downloadRelease: 'Download installer',
      azureGuide: 'Free Azure guide',
    },
    disclaimer: {
      title: 'Attention!',
    ...
    quota: {
      title: 'Free quota exhausted: use your Azure key',
      intro: "Microsoft's free API is rate-limited (resets every ~24h). With your own Azure Speech key (free F0 tier) there is no quota. Follow these steps (5 minutes):",
      s1t: '1. Create your free Azure account',
      s1d: "If you don't have one, sign up free (includes 12 months of free services).",
      freeBtn: 'Create free account',
      s2t: '2. Create a Speech resource',
      s2d: 'In the portal, create a “Speech” resource with the F0 (free) pricing tier.',
      portalBtn: 'Open portal: create Speech',
      s3t: '3. Pick region and F0 tier',
      s3d: 'Example: eastus region with the F0 tier (500,000 free speech characters per month).',
      s4t: '4. Copy your KEY and region',
      s4d: 'In the resource → Keys and Endpoint: copy KEY 1 and the Location.',
      example: 'Example: KEY 1 = 8f3a…9c2e (32 characters) · Location = eastus',
      s5t: '5. Paste it into this app',
      s5d: 'Settings → SpeechKey + ServiceRegion, and Interface → Azure Speech API.',
      guideBtn: 'Official step-by-step guide',
      settingsBtn: 'Go to Settings now',
    },
    ...
    messages: {
      ...
      gptNoKey: "Missing key: set it in Settings → AI API Key (free at openrouter.ai/keys or opencode.ai/auth).",
      gptBadKey: "Key rejected (401): check it in Settings → AI API Key.",
      gptProviderDown: "The free model failed at its provider. Try another “gratis” model from the dropdown (they rotate and sometimes saturate).",
  ...
  es: {
    ...
    guide: {
      title: 'Guía rápida',
      intro: 'Convierte texto a voz en 4 pasos. Sin cuenta para lo básico.',
      s1t: '1. Elige idioma y voz',
      s1d: 'Ya vienen Español (Colombia) con la voz Salome por defecto.',
      s2t: '2. Escribe o pega tu texto',
      s2d: 'Usa la pestaña Texto, o carga archivos .txt en modo Lote.',
      s3t: '3. Pulsa Iniciar conversión',
      s3d: 'Escucha en el reproductor o descarga el MP3.',
      s4t: '4. Para uso sin límite, agrega tu clave Azure',
      s4d: 'Ajustes → SpeechKey + ServiceRegion, Interfaz → Azure Speech API.',
      faqTitle: 'Problemas comunes',
      faq429: 'cuota gratuita agotada, se renueva en ~24 h. La app te ofrece la guía Azure.',
      faq403: 'endpoint gratuito rechazando conexiones. Misma solución: tu propia clave Azure.',
      faqF9: 'trae la ventana al frente desde cualquier lugar.',
    },
    version: {
    ...
    donate: {
      ...
      viewFork: 'Ver fork en GitHub',
      downloadRelease: 'Descargar instalador',
      azureGuide: 'Guía Azure gratis',
    },
    disclaimer: {
      title: '¡Atención!',
    ...
    quota: {
      title: 'Cuota gratuita agotada: usa tu clave de Azure',
      intro: 'La API gratuita de Microsoft está limitada (se renueva cada ~24 h). Con tu propia clave de Azure Speech (nivel gratuito F0) no hay cuota. Sigue estos pasos (5 minutos):',
      s1t: '1. Crea tu cuenta gratuita de Azure',
      s1d: 'Si no tienes cuenta, créala gratis (incluye 12 meses de servicios gratuitos).',
      freeBtn: 'Crear cuenta gratis',
      s2t: '2. Crea un recurso de voz (Speech)',
      s2d: 'En el portal, crea un recurso «Speech» con nivel de precios F0 (gratis).',
      portalBtn: 'Abrir portal: crear Speech',
      s3t: '3. Elige región y nivel F0',
      s3d: 'Ejemplo: región eastus con nivel F0 (500.000 caracteres de voz gratis al mes).',
      s4t: '4. Copia tu KEY y tu región',
      s4d: 'En el recurso → Claves y punto de conexión: copia KEY 1 y la Ubicación.',
      example: 'Ejemplo: KEY 1 = 8f3a…9c2e (32 caracteres) · Ubicación = eastus',
      s5t: '5. Pégala en esta app',
      s5d: 'Ajustes → SpeechKey + ServiceRegion, e Interfaz → Azure Speech API.',
      guideBtn: 'Guía oficial paso a paso',
      settingsBtn: 'Ir a Ajustes ahora',
    },
    configPage: {
      ...
      yes: 'Sí',
      no: 'No',
      serviceRegionPlaceHolder: "Complete la región de servicio, como por ejemplo: eastus",
      confirm: 'OK',
      voice: 'Voz',
      style: 'Estilo',
      role: 'Rol',
      ...
      pitch: 'Tono',
      remove: 'Eliminar',
      openAIKey: 'Clave API IA',
      gptModel: 'Modelo GPT',
      aiProvider: 'Proveedor IA',
      aiBaseUrl: 'URL Base IA',
      aiCustom: 'Personalizado',
      darkMode: 'Modo Oscuro',
      aiKeyHint: 'Consigue una clave gratis en openrouter.ai/keys (modelos gratis) o usa tu clave de OpenAI.',
    ...
    messages: {
      ...
      gptNoKey: "Falta la clave: configúrala en Ajustes → Clave API IA (gratis en openrouter.ai/keys o en opencode.ai/auth).",
      gptBadKey: "Clave rechazada (401): revísala en Ajustes → Clave API IA.",
      gptProviderDown: "El modelo gratuito falló en su proveedor. Prueba con otro modelo «gratis» del desplegable (rotan y a veces se saturan).",
  ...
  zh: {
    ...
    guide: {
      title: '快速指南',
      intro: '4 步将文本转为语音，基础功能无需账户。',
      s1t: '1. 选择语言和语音',
      s1d: '默认已是西班牙语（哥伦比亚）Salome 语音。',
      s2t: '2. 输入或粘贴文本',
      s2d: '使用“文本”选项卡，或在批量模式加载 .txt 文件。',
      s3t: '3. 点击开始转换',
      s3d: '在下方播放器试听或下载 MP3。',
      s4t: '4. 无限使用请添加 Azure 密钥',
      s4d: '设置 → SpeechKey + ServiceRegion，接口 → Azure Speech API。',
      faqTitle: '常见问题',
      faq429: '免费配额用完，约24小时恢复。应用会提供 Azure 指南。',
      faq403: '免费端点拒绝连接。同样方案：使用自己的 Azure 密钥。',
      faqF9: '从任何地方将窗口置于前台。',
    },
    version: {
      checkUpdate: '检查更新',
    ...
    configPage: {
      ...
      yes: '是',
      no: '否',
      serviceRegionPlaceHolder: "请填写ServiceRegion，如：eastus",
      confirm: '确认',
      voice: '语音',
      style: '风格',
      role: '角色',
      ...
      aiCustom: '自定义',
      darkMode: '深色模式',
      aiKeyHint: '在 openrouter.ai/keys 获取免费密钥（免费模型）或使用 OpenAI 密钥。',
    ...
    donate: {
      ...
      viewFork: '在 GitHub 上查看 Fork',
      downloadRelease: '下载安装包',
      azureGuide: '免费 Azure 指南',
    },
    disclaimer: {
      title: '注意！',
    ...
    quota: {
      title: '免费配额已用完：使用你自己的 Azure 密钥',
      intro: '微软免费接口限流（约24小时恢复）。使用自己的 Azure Speech 密钥（免费 F0）则无配额限制，只需 5 分钟：',
      s1t: '1. 创建免费 Azure 账户',
      s1d: '如果没有账户，免费注册（含 12 个月免费服务）。',
      freeBtn: '免费创建账户',
      s2t: '2. 创建语音（Speech）资源',
      s2d: '在门户中创建“Speech”资源，定价层选择 F0（免费）。',
      portalBtn: '打开门户：创建 Speech',
      s3t: '3. 选择区域和 F0 层',
      s3d: '示例：区域 eastus，F0 层（每月50万字符免费语音）。',
      s4t: '4. 复制 KEY 和区域',
      s4d: '在资源 → 密钥和终结点中复制 KEY 1 和位置。',
      example: '示例：KEY 1 = 8f3a…9c2e（32 个字符）· 位置 = eastus',
      s5t: '5. 粘贴到本应用',
      s5d: '设置 → SpeechKey + ServiceRegion，并将接口切换为 Azure Speech API。',
      guideBtn: '官方分步指南',
      settingsBtn: '立即前往设置',
    },
    footer: {
    ...
    messages: {
      ...
      gptFailed: "GPT 请求失败",
      gptNoKey: "缺少密钥：请在设置 → AI API Key 中配置（可在 openrouter.ai/keys 或 opencode.ai/auth 免费获取）。",
      gptBadKey: "密钥被拒绝 (401)：请检查设置 → AI API Key。",
      gptProviderDown: "免费模型在其提供商处失败。请尝试下拉列表中的另一个“gratis”模型（会轮换，有时会饱和）。",
